package lk.ijse.elite.sendMail;
...
public class SendEmail {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT,GsonFactory gsonFactory)
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(gsonFactory,
                new InputStreamReader(SendEmail.class.getResourceAsStream
                        ("/api/client_secret_904902990196-9u0quu6tkq9p8d4vem9egao8bur4sm0r.apps.googleusercontent.com.json"))); // enter your credential
